...
| G1381 | Daily Recommendations: resetmelding bewaakt forced-colors disabled touchcopy | P1 | F5 | ☑ |
| G1382 | Daily Recommendations: resetmelding bewaakt guarded helpercopy in reduced-motion | P1 | F5 | ☑ |
...
| G1421 | Dossier upload microcopy start met één compacte hulphint | P1 | F5 | ☑ |
| G1422 | Dossier upload keuze-uitleg start met één compacte uitlegkaart | P1 | F5 | ☑ |
| G1424 | Dossier upload triage start met één compacte invoerkeuze | P1 | F5 | ☑ |
...
| G1430 | Dossier zoekroute vervolgcontext start met één compacte resultaatkeuze | P1 | F5 | ☑ |
| G1431 | Dossier tijdlijnroute start met één compacte tijdlijnkeuze | P1 | F5 | ☑ |
| G1432 | Dossier imaging follow-up start met één compacte beeldcontextkeuze | P1 | F5 | ☑ |
...
| G1441 | Kennis filters starten met één compacte filterkeuze | P1 | F5 | ☑ |
| G1442 | Kennis taakroutes starten met één compacte routekeuze | P1 | F5 | ☑ |
| G1443 | Kennis researchscan start met één compacte scankeuze | P1 | F5 | ☑ |
| G1444 | Kennis werkbankstatus start met één compacte statuskeuze | P1 | F5 | ☑ |
| G1445 | Kennis filterformulier start met één compacte formulierkeuze | P1 | F5 | ☑ |
| G1446 | Kennis filterstatus start met één compacte statuskeuze | P1 | F5 | ☑ |
| G1447 | Kennis bibliotheeklijst start met één compacte lijstkeuze | P1 | F5 | ☑ |
| G1448 | Kennis bibliotheekkaartdetails starten met één compacte detailkeuze | P1 | F5 | ☑ |
| G1449 | Kennis AI samenvattingdetails starten met één compacte detailkeuze | P1 | F5 | ☑ |
| G1450 | Kennis AI instellingen starten met één compacte instellingkeuze | P1 | F5 | ☑ |
| G1451 | Kennis AI researchnetwerk start met één compacte netwerkkeuze | P1 | F5 | ☑ |
...
| G1465 | Kennis research snapshot start met één compacte scankeuze | P1 | F5 | ☑ |
| G1466 | Kennis research werkbankstatus start met één compacte metricskeuze | P1 | F5 | ☑ |
| G1467 | Kennis bibliotheek filterpaneel start met één compacte filterkeuze | P1 | F5 | ☑ |
| G1468 | Kennis bibliotheek filterstatus start met één compacte statusdetailkeuze | P1 | F5 | ☑ |
| G1469 | Kennis bibliotheek lijst start met één compacte lijstkeuze | P1 | F5 | ☑ |
| G1470 | Kennis bibliotheek kaartdetails start met één compacte detailkeuze | P1 | F5 | ☑ |
| G1471 | Kennis AI-preview start met één compacte previewkeuze | P1 | F5 | ☑ |
| G1472 | Kennis AI-samenvatting bewaren start met één compacte opslagkeuze | P1 | F5 | ☑ |
| G1473 | Kennis AI-instellingen start met één compacte instellingenkeuze | P1 | F5 | ☑ |
| G1474 | Kennis researchnetwerk start met één compacte netwerkkeuze | P1 | F5 | ☑ |
| G1475 | Kennis toevoegroute researchformulier start met één compacte invoerkeuze | P1 | F5 | ☑ |
| G1476 | Kennis toevoegroute eigen kennisitem start met één compacte itemkeuze | P1 | F5 | ☑ |
| G1477 | Kennis toevoegroute vervolgacties starten met één compacte actie-keuze | P1 | F5 | ☑ |
...
| G1495 | Kennis bibliotheek herstelactie badges tonen mobiele tapruimte | P1 | F5 | ☑ |
| G1496 | Kennis bibliotheek herstelactie badges tonen mobiele focusring | P1 | F5 | ☑ |
| G1497 | Kennis bibliotheek herstelactie badges houden focusring vrij van badge-overlap | P1 | F5 | ☑ |
| G1498 | Kennis bibliotheek herstelactie badges tonen compacte disabled-vrije routes | P1 | F5 | ☑ |
| G1499 | Kennis bibliotheek herstelactie badges tonen actieve hovercursor consistent | P1 | F5 | ☑ |
| G1500 | Kennis bibliotheek herstelactie badges tonen consistente badge-hover | P1 | F5 | ☑ |
| G1501 | Kennis bibliotheek herstelactie badges tonen consistente focusgewicht | P1 | F5 | ☑ |
| G1502 | Kennis bibliotheek herstelactie badges houden focuscopy secundair | P1 | F5 | ☑ |
| G1503 | Kennis bibliotheek herstelactie badges houden labelcopy primair | P1 | F5 | ☑ |
| G1504 | Kennis bibliotheek herstelactie badges houden mobiele labelruimte stabiel | P1 | F5 | ☑ |
| G1505 | Kennis bibliotheek herstelactie badges houden mobiele badgekolom compact | P1 | F5 | ☑ |
| G1506 | Kennis bibliotheek herstelactie badges houden mobiele ellipsis leesbaar | P1 | F5 | ☑ |
| G1507 | Kennis bibliotheek herstelactie badges houden mobiele truncatie rustig | P1 | F5 | ☑ |
| G1508 | Kennis bibliotheek herstelactie badges houden mobiele focusmaat stabiel | P1 | F5 | ☑ |
| G1509 | Kennis bibliotheek herstelactie badges houden mobiele boxmaat stabiel | P1 | F5 | ☑ |
| G1510 | Kennis bibliotheek herstelactie badges houden mobiele inhoud gecentreerd | P1 | F5 | ☑ |
...
| G1516 | Kennis bibliotheek herstelactie badges houden mobiele focushalo stabiel | P1 | F5 | ☑ |
| G1517 | Kennis bibliotheek herstelactie badges houden mobiele focusbegrenzing rustig | P1 | F5 | ☑ |
| G1518 | Kennis bibliotheek herstelactie badges houden mobiele focusvlak licht | P1 | F5 | ☑ |
| G1519 | Kennis bibliotheek herstelactie badges houden mobiele focusvlak consistent | P1 | F5 | ☑ |
| G1520 | Kennis bibliotheek herstelactie badges houden mobiele hovervlak licht | P1 | F5 | ☑ |
| G1521 | Kennis bibliotheek herstelactie badges houden mobiele hoverbegrenzing rustig | P1 | F5 | ☑ |
| G1522 | Kennis bibliotheek herstelactie badges houden mobiele hoverbadge rustig | P1 | F5 | ☑ |
| G1523 | Kennis bibliotheek herstelactie badges houden mobiele hoverbadge leesbaar | P1 | F5 | ☑ |
| G1524 | Kennis bibliotheek herstelactie badges houden mobiele hoverbadge compact | P1 | F5 | ☑ |
| G1525 | Kennis bibliotheek herstelactie badges houden mobiele hoverbadge truncatie rustig | P1 | F5 | ☑ |
| G1526 | Kennis bibliotheek herstelactie badges houden mobiele hoverbadge breedte begrensd | P1 | F5 | ☑ |
| G1527 | Kennis bibliotheek herstelactie badges beschermen mobiele labellijn | P1 | F5 | ☑ |
| G1528 | Kennis bibliotheek herstelactie badges houden mobiele labellijn truncatie rustig | P1 | F5 | ☑ |
| G1529 | Kennis bibliotheek herstelactie badges houden mobiele labellijn focuskleur rustig | P1 | F5 | ☑ |
| G1530 | Kennis bibliotheek herstelactie badges houden mobiele hoverlabel kleur rustig | P1 | F5 | ☑ |
...
| G1536 | Kennis bibliotheek herstelactie badges houden mobiele badgecascade dekking compleet | P1 | F5 | ☑ |
| G1537 | Kennis bibliotheek herstelactie badges houden mobiele badgefocus sterker dan hover | P1 | F5 | ☑ |
| G1538 | Kennis bibliotheek herstelactie badges houden mobiele badgehover secundair | P1 | F5 | ☑ |
| G1539 | Kennis bibliotheek herstelactie badges houden mobiele badgehover tekst rustig | P1 | F5 | ☑ |
| G1540 | Kennis bibliotheek herstelactie badges houden mobiele badgehover rand rustig | P1 | F5 | ☑ |
| G1541 | Kennis bibliotheek herstelactie badges houden mobiele badgehover achtergrond rustig | P1 | F5 | ☑ |
| G1542 | Kennis bibliotheek herstelactie badges houden mobiele badgehover breedte compact | P1 | F5 | ☑ |
| G1543 | Kennis bibliotheek herstelactie badges houden mobiele badgehover truncatie stabiel | P1 | F5 | ☑ |
| G1544 | Kennis bibliotheek herstelactie badges houden mobiele badgehover minimale breedte stabiel | P1 | F5 | ☑ |
| G1545 | Kennis bibliotheek herstelactie badges houden mobiele badgehover rijhoogte stabiel | P1 | F5 | ☑ |
| G1546 | Kennis bibliotheek herstelactie badges houden mobiele badgehover focushoogte gelijk | P1 | F5 | ☑ |
| G1547 | Kennis bibliotheek herstelactie badges houden mobiele badgehover focusbreedte gelijk | P1 | F5 | ☑ |
| G1548 | Kennis bibliotheek herstelactie badges houden mobiele badgehover maxbreedte gelijk | P1 | F5 | ☑ |
| G1549 | Kennis bibliotheek herstelactie badges houden mobiele badgehover flexbasis gelijk | P1 | F5 | ☑ |
| G1550 | Kennis bibliotheek herstelactie badges houden mobiele badgehover flexkrimp stabiel | P1 | F5 | ☑ |
| G1551 | Kennis bibliotheek herstelactie badges houden mobiele badgehover flexgroei stabiel | P1 | F5 | ☑ |
| G1552 | Kennis bibliotheek herstelactie badges houden mobiele badgehover flexcontract compleet | P1 | F5 | ☑ |
| G1553 | Kennis bibliotheek herstelactie badges houden mobiele badgehover flexcontract volgorde stabiel | P1 | F5 | ☑ |
| G1554 | Kennis bibliotheek herstelactie badges houden mobiele badgehover flexbasis responsief | P1 | F5 | ☑ |
...
| G1560 | Kennis bibliotheek herstelactie badges houden mobiele badgehover minimum onder inlinebreedte | P1 | F5 | ☑ |
| G1561 | Kennis bibliotheek herstelactie badges houden mobiele badgehover minimum onder flexbasis | P1 | F5 | ☑ |
| G1562 | Kennis bibliotheek herstelactie badges houden mobiele badgehover minimumrelaties compleet | P1 | F5 | ☑ |
| G1563 | Kennis bibliotheek herstelactie badges houden mobiele badgehover responsive contract compact | P1 | F5 | ☑ |
| G1564 | Kennis bibliotheek herstelactie badges houden mobiele badgehover responsive contract volgorde stabiel | P1 | F5 | ☑ |
| G1565 | Kennis bibliotheek herstelactie badges houden mobiele badgehover responsive contractwaarden stabiel | P1 | F5 | ☑ |
...
| G1570 | Premium Claude Design UI houdt desktop routewerkruimte als begrensde app-panelen | P1 | F5 | ☑ |
| G1571 | Premium Claude Design UI houdt routepaneelkop sticky binnen actieve werkruimte | P1 | F5 | ☑ |
| G1572 | Premium Claude Design UI geeft contextrail een compacte sticky paneelkop | P1 | F5 | ☑ |
| G1573 | Premium Claude Design UI houdt mobiele formulieracties compact en rustig | P1 | F5 | ☑ |
| G1574 | Premium Claude Design UI houdt de algemene medische disclaimer korter | P2 | F5 | ☑ |
...
| G1590 | Traject graphcontext opent als compacte panelen | P1 | F5 | ☑ |
...
| G1599 | Vragen gebruikt korte standaard gespreksdisclaimer | P2 | F5 | ☑ |
...
| G1604 | Beelden vergelijken gebruikt korte contextdisclaimer | P2 | F5 | ☑ |
| G1605 | Uploadflows gebruiken korte contextdisclaimers | P2 | F5 | ☑ |
| G1606 | Traject context gebruikt korte contextdisclaimers | P2 | F5 | ☑ |
| G1607 | Consult bronreview gebruikt korte contextdisclaimer | P2 | F5 | ☑ |
...
| G1613 | Dossier leesmodus gebruikt korte contextdisclaimer | P2 | F5 | ☑ |
...
| G1619 | Medicatie beheerroute gebruikt korte kliniektekstcontext | P2 | F5 | ☑ |
...
| G1625 | Medicatie planning routeheader gebruikt korte routecontext | P2 | F5 | ☑ |
| G1626 | Medicatie historie routeheader gebruikt korte terugleescontext | P2 | F5 | ☑ |
| G1627 | Medicatie import routeheader gebruikt korte schemacontext | P2 | F5 | ☑ |
| G1628 | Medicatie import samenvatting gebruikt korte importcontext | P2 | F5 | ☑ |
...
| G1634 | Medicatie import statusbadge gebruikt korte feedbacklabel | P2 | F5 | ☑ |
| G1635 | Medicatie import foutbadge gebruikt korte checklabel | P2 | F5 | ☑ |
| G1636 | Medicatie import primaire actie gebruikt korte beheerlabel | P2 | F5 | ☑ |
| G1637 | Medicatie import secundaire actie gebruikt korte planninglabel | P2 | F5 | ☑ |
| G1638 | Medicatie import disclosure gebruikt korte actiecopy | P2 | F5 | ☑ |
| G1639 | Medicatie import formulierlabel gebruikt korte invoercopy | P2 | F5 | ☑ |
| G1640 | Medicatie import placeholder gebruikt generieke voorbeeldcopy | P2 | F5 | ☑ |
| G1641 | Medicatie import helper gebruikt voorbeeldindicator | P2 | F5 | ☑ |
| G1642 | Medicatie import knop krijgt expliciete lokale actiecopy | P2 | F5 | ☑ |
| G1643 | Medicatie import success feedback gebruikt lokale verwerkingscopy | P2 | F5 | ☑ |
| G1644 | Medicatie import feedback context noemt lokale planning | P2 | F5 | ☑ |
| G1645 | Medicatie import foutcontext noemt lokale controle | P2 | F5 | ☑ |
| G1646 | Medicatie import foutcontext noemt importfeedback | P2 | F5 | ☑ |
| G1647 | Medicatie import fouttitel gebruikt lokale correctiecopy | P2 | F5 | ☑ |
| G1648 | Medicatie import foutbadge gebruikt lokale aandachtcopy | P2 | F5 | ☑ |
| G1649 | Medicatie import standaardbadge gebruikt korte planningscopy | P2 | F5 | ☑ |
| G1650 | Medicatie import standaardtitel noemt lokale planning | P2 | F5 | ☑ |
| G1651 | Medicatie import standaarddetail gebruikt directe planningscopy | P2 | F5 | ☑ |
| G1652 | Medicatie import routeheader gebruikt directe lokale planningscopy | P2 | F5 | ☑ |
| G1653 | Medicatie import routetitel gebruikt lokale invoercopy | P2 | F5 | ☑ |
| G1654 | Medicatie import navigatie gebruikt lokale invoercopy | P2 | F5 | ☑ |
...
| G1660 | Medicatie planning routesamenvatting actie noemt lokale invoer | P2 | F5 | ☑ |
| G1661 | Medicatie planning primaire actie noemt volgend moment kort | P2 | F5 | ☑ |
| G1662 | Medicatie planning primaire paneeltitel gebruikt lege-state copy | P2 | F5 | ☑ |
| G1663 | Medicatie planning lege empty-state titel noemt vervolgplanning | P2 | F5 | ☑ |
| G1664 | Medicatie planning lege tekst noemt beheer als eerste stap | P2 | F5 | ☑ |
...
| G1670 | Medicatie planning primaire routeactie blijft herkenbaar | P2 | F5 | ☑ |
| G1671 | Medicatie planning secundaire actie noemt opties | P2 | F5 | ☑ |
| G1672 | Medicatie planning routekeuze titel noemt opties | P2 | F5 | ☑ |
| G1673 | Medicatie planning routeopties helper noemt lokale import | P2 | F5 | ☑ |
| G1674 | Medicatie planning routeopties teller noemt later medicatie compact | P2 | F5 | ☑ |
| G1675 | Medicatie planning routeopties navigatie noemt import lokaal | P2 | F5 | ☑ |
| G1676 | Medicatie planning routeopties historielink noemt teruglezen | P2 | F5 | ☑ |
| G1677 | Medicatie planning routeopties beheerlink noemt beheren kort | P2 | F5 | ☑ |
| G1678 | Medicatie planning routeopties vandaaglink noemt afvinken kort | P2 | F5 | ☑ |
| G1679 | Medicatie planning routeopties helper noemt afvinken compact | P2 | F5 | ☑ |
| G1680 | Medicatie planning routeopties titel noemt kiezen compact | P2 | F5 | ☑ |
...
| G1686 | Medicatie planning routeopties importlink noemt planninginvoer compact | P2 | F5 | ☑ |
| G1687 | Medicatie planning routeopties helper noemt planninginvoer gelijk | P2 | F5 | ☑ |
| G1688 | Medicatie planning routeopties helper noemt importactie als invoer | P2 | F5 | ☑ |
| G1689 | Medicatie planning routeopties helper noemt toevoegen rustiger | P2 | F5 | ☑ |
| G1690 | Medicatie planning routeopties helper noemt aanvullen zonder herhaling | P2 | F5 | ☑ |
| G1691 | Medicatie planning routeopties helper noemt aanvullen met routecontext | P2 | F5 | ☑ |
| G1692 | Medicatie planning routeopties helper gebruikt korte planningterm | P2 | F5 | ☑ |
| G1693 | Medicatie planning routeopties helper gebruikt natuurlijke planningterm | P2 | F5 | ☑ |
| G1694 | Medicatie planning routeopties helper noemt planningaanvulling als zelfstandig woord | P2 | F5 | ☑ |
...
| G1703 | Premium Claude Design UI: dossier upload beeldcontext chips behouden touchruimte | P1 | F5 | ☑ |
| G1704 | Premium Claude Design UI: dossier upload beeldcontext velden tonen scanbare volgorde | P1 | F5 | ☑ |
| G1705 | Premium Claude Design UI: dossier upload beeldcontext veldlabels blijven compact op mobiel | P1 | F5 | ☑ |
| G1706 | Premium Claude Design UI: dossier upload beeldcontext velden openen behoudt compact ritme | P1 | F5 | ☑ |
| G1707 | Premium Claude Design UI: dossier upload beeldcontext invoervelden houden focusruimte | P1 | F5 | ☑ |
| G1708 | Premium Claude Design UI: dossier upload beeldcontext focus blijft zichtbaar in forced colors | P1 | F5 | ☑ |
| G1709 | Premium Claude Design UI: dossier upload beeldcontext labelnummers blijven leesbaar in forced colors | P1 | F5 | ☑ |
| G1710 | Premium Claude Design UI: dossier upload beeldcontext forced-colors focus en labelcontrast blijven samen rustig | P1 | F5 | ☑ |
| G1711 | Premium Claude Design UI: dossier upload beeldcontext forced-colors focus badge blijft compact op small mobile | P1 | F5 | ☑ |
| G1712 | Premium Claude Design UI: dossier upload beeldcontext forced-colors badge tekst blijft gecentreerd | P1 | F5 | ☑ |
...
| G1718 | Premium Claude Design UI: dossier upload beeldcontext forced-colors badge cijfer behoudt compact formaat | P1 | F5 | ☑ |
| G1719 | Premium Claude Design UI: dossier upload beeldcontext forced-colors badge regelhoogte blijft compact | P1 | F5 | ☑ |
| G1720 | Premium Claude Design UI: dossier upload beeldcontext forced-colors badge centrering blijft stabiel met compacte regelhoogte | P1 | F5 | ☑ |
| G1721 | Premium Claude Design UI: dossier upload beeldcontext forced-colors badge nulpadding blijft stabiel | P1 | F5 | ☑ |
| G1722 | Premium Claude Design UI: dossier upload beeldcontext forced-colors badge outline blijft rustig | P1 | F5 | ☑ |
| G1723 | Premium Claude Design UI: dossier upload beeldcontext forced-colors badge tekstuitlijning blijft rustig | P1 | F5 | ☑ |
| G1724 | Premium Claude Design UI: app-shell tablet werkruimte scrollt als paneel in plaats van lange pagina | P1 | F5 | ☑ |
| G1725 | Premium Claude Design UI: app-shell desktop routekop blijft compact boven paneelscroll | P1 | F5 | ☑ |
| G1726 | Premium Claude Design UI: app-shell desktop paneel behoudt stabiele scrollruimte zonder horizontale druk | P1 | F5 | ☑ |
| G1727 | Premium Claude Design UI: app-shell tablet chrome behoudt compacte routekop boven paneelscroll | P1 | F5 | ☑ |
| G1728 | Premium Claude Design UI: app-shell tablet paneel behoudt stabiele scrollruimte zonder horizontale druk | P1 | F5 | ☑ |
| G1729 | Premium Claude Design UI: app-shell mobiel screen-stage behoudt rustige paneelruimte boven bottom-nav | P1 | F5 | ☑ |
| G1730 | Premium Claude Design UI: app-shell mobiel workspace-strip behoudt compacte hoogte boven content | P1 | F5 | ☑ |
| G1731 | Premium Claude Design UI: app-shell mobiel workspace-strip knoppen blijven compact swipebaar | P1 | F5 | ☑ |
| G1732 | Premium Claude Design UI: app-shell mobiel workspace-strip actieve knop blijft duidelijk in compacte rij | P1 | F5 | ☑ |
| G1733 | Premium Claude Design UI: app-shell mobiel workspace-strip scrollpositie brengt actieve knop in beeld | P1 | F5 | ☑ |
| G1734 | Premium Claude Design UI: app-shell mobiel workspace-strip behoudt actieve context bij browser terug | P1 | F5 | ☑ |
| G1735 | Premium Claude Design UI: app-shell mobiel workspace-strip behoudt rustige focus na directe link | P1 | F5 | ☑ |
| G1736 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt directe link op small-mobile | P1 | F5 | ☑ |
| G1737 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt history-flow op small-mobile | P1 | F5 | ☑ |
| G1738 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt actieve knop na herladen | P1 | F5 | ☑ |
| G1739 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload-focus zonder knopfocus | P1 | F5 | ☑ |
| G1740 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload hash op small-mobile | P1 | F5 | ☑ |
| G1741 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload paneelpositie op small-mobile | P1 | F5 | ☑ |
| G1742 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload paneel scrollstart op small-mobile | P1 | F5 | ☑ |
| G1743 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload body-scroll op small-mobile | P1 | F5 | ☑ |
| G1744 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload chrome compactheid op small-mobile | P1 | F5 | ☑ |
| G1745 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload workspace-strip hoogte op small-mobile | P1 | F5 | ☑ |
| G1746 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop breedte op small-mobile | P1 | F5 | ☑ |
| G1747 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop positie op small-mobile | P1 | F5 | ☑ |
| G1748 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop focusring op small-mobile | P1 | F5 | ☑ |
| G1749 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop tekstafkapping op small-mobile | P1 | F5 | ☑ |
| G1750 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher scrollbreedte op small-mobile | P1 | F5 | ☑ |
| G1751 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher scrollbar verberging op small-mobile | P1 | F5 | ☑ |
| G1752 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher overscroll op small-mobile | P1 | F5 | ☑ |
| G1753 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher snap op small-mobile | P1 | F5 | ☑ |
| G1754 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop snap-align op small-mobile | P1 | F5 | ☑ |
| G1755 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher scroll-padding op small-mobile | P1 | F5 | ☑ |
| G1756 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop scroll-margin op small-mobile | P1 | F5 | ☑ |
| G1757 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop snap-stop op small-mobile | P1 | F5 | ☑ |
| G1758 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher touch-pan op small-mobile | P1 | F5 | ☑ |
| G1759 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop text-size-adjust op small-mobile | P1 | F5 | ☑ |
| G1760 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop font-smoothing op small-mobile | P1 | F5 | ☑ |
| G1761 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload actieve stripknop tap-highlight op small-mobile | P1 | F5 | ☑ |
| G1762 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher gap op small-mobile | P1 | F5 | ☑ |
| G1763 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher align-items op small-mobile | P1 | F5 | ☑ |
| G1764 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher justify-content op small-mobile | P1 | F5 | ☑ |
| G1765 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher display op small-mobile | P1 | F5 | ☑ |
| G1766 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher min-width op small-mobile | P1 | F5 | ☑ |
| G1767 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher max-width op small-mobile | P1 | F5 | ☑ |
| G1768 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher flex-shrink op small-mobile | P1 | F5 | ☑ |
| G1769 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher flex-grow op small-mobile | P1 | F5 | ☑ |
| G1770 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher flex-basis op small-mobile | P1 | F5 | ☑ |
| G1771 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher box-sizing op small-mobile | P1 | F5 | ☑ |
| G1772 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher padding-inline op small-mobile | P1 | F5 | ☑ |
| G1773 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher padding-block op small-mobile | P1 | F5 | ☑ |
| G1774 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher margin-inline op small-mobile | P1 | F5 | ☑ |
| G1775 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher margin-block op small-mobile | P1 | F5 | ☑ |
| G1776 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher border-width op small-mobile | P1 | F5 | ☑ |
| G1777 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher border-style op small-mobile | P1 | F5 | ☑ |
| G1778 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher border-color op small-mobile | P1 | F5 | ☑ |
| G1779 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher border-radius op small-mobile | P1 | F5 | ☑ |
| G1780 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher background op small-mobile | P1 | F5 | ☑ |
| G1781 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher box-shadow op small-mobile | P1 | F5 | ☑ |
| G1782 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher filter op small-mobile | P1 | F5 | ☑ |
| G1783 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher backdrop-filter op small-mobile | P1 | F5 | ☑ |
| G1784 | Premium Claude Design UI: app-shell mobiel workspace-strip bewaakt reload switcher opacity op small-mobile | P1 | F5 | ☑ |
...
| G1802 | Premium Claude Design UI: Dossier upload small-mobile route summary border rustiger | P1 | F5 | ☑ |
| G1803 | Premium Claude Design UI: Dossier upload small-mobile route summary tekstcontrast rustiger | P1 | F5 | ☑ |
| G1804 | Premium Claude Design UI: Dossier upload small-mobile route summary focus-ring rustiger | P1 | F5 | ☑ |
| G1805 | Premium Claude Design UI: Dossier upload small-mobile route selector top border rustiger | P1 | F5 | ☑ |
| G1806 | Premium Claude Design UI: Dossier upload small-mobile route selector achtergrond rustiger | P1 | F5 | ☑ |
| G1807 | Premium Claude Design UI: Dossier upload small-mobile routekaart achtergrondcontrast rustiger | P1 | F5 | ☑ |
| G1808 | Premium Claude Design UI: Dossier upload small-mobile routekaart actieve lijn rustiger | P1 | F5 | ☑ |
| G1809 | Premium Claude Design UI: Dossier upload small-mobile routekaart actieve randcontrast rustiger | P1 | F5 | ☑ |
| G1810 | Premium Claude Design UI: Dossier upload small-mobile routekaart actieve achtergrond rustiger | P1 | F5 | ☑ |
| G1811 | Premium Claude Design UI: Dossier upload small-mobile routekaart actieve schaduw rustiger | P1 | F5 | ☑ |
| G1812 | Premium Claude Design UI: Dossier upload small-mobile routekaart actieve focus rustiger | P1 | F5 | ☑ |
...
| G1818 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors tekstcontrast explicieter | P1 | F5 | ☑ |
| G1819 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve labeltoon rustiger | P1 | F5 | ☑ |
| G1820 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve titeltoon rustiger | P1 | F5 | ☑ |
| G1821 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve contextregel rustiger | P1 | F5 | ☑ |
...
| G1827 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve micro-label decoratie rustig | P1 | F5 | ☑ |
| G1828 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve micro-label letterspatiëring rustig | P1 | F5 | ☑ |
| G1829 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve micro-label tekstvariant rustig | P1 | F5 | ☑ |
| G1830 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve micro-label teksttransformatie rustig | P1 | F5 | ☑ |
| G1831 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve micro-label tekststijl rustig | P1 | F5 | ☑ |
| G1832 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve micro-label witruimte rustig | P1 | F5 | ☑ |
| G1833 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve micro-label woordbreuk rustig | P1 | F5 | ☑ |
| G1834 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve micro-label woordbreekmodus rustig | P1 | F5 | ☑ |
| G1835 | Premium Claude Design UI: Dossier upload small-mobile routekaart forced-colors actieve micro-label afbreektekens rustig | P1 | F5 | ☑ |
...
| G1853 | Central Encrypted Platform: attachment envelope batch hash progress UI | P1 | F5 | ☑ |
| G1854 | Central Encrypted Platform: attachment envelope batch progress forced-colors evidence | P1 | F5 | ☑ |
| G1855 | Central Encrypted Platform: attachment envelope batch forced-colors routeflow screenshot evidence | P1 | F5 | ☑ |
...
| G1862 | Premium Claude Design UI: research summary first-viewport reading board | P1 | F5 | ☑ |
| G1863 | Premium Claude Design UI: daily recommendations first-viewport decision board | P1 | F5 | ☑ |
| G1864 | Premium Claude Design UI: dossier timeline first-viewport event board | P1 | F5 | ☑ |
| G1865 | Premium Claude Design UI: treatment context first-viewport decision board | P1 | F5 | ☑ |
| G1866 | Premium Claude Design UI: wellbeing history first-viewport signal board | P1 | F5 | ☑ |
| G1867 | Premium Claude Design UI: decision history first-viewport review board | P1 | F5 | ☑ |
| G1868 | Premium Claude Design UI: finance history first-viewport cost board | P1 | F5 | ☑ |
| G1869 | Premium Claude Design UI: medication history first-viewport intake board | P1 | F5 | ☑ |
| G1870 | Premium Claude Design UI: schedule history first-viewport planning board | P1 | F5 | ☑ |
| G1871 | Premium Claude Design UI: reminders history first-viewport notification board | P1 | F5 | ☑ |
...
| G1877 | Premium Claude Design UI: daily advice route first-viewport selection board | P1 | F5 | ☑ |
| G1878 | Premium Claude Design UI: knowledge research route first-viewport source board | P1 | F5 | ☑ |
| G1879 | Premium Claude Design UI: knowledge library route first-viewport index board | P1 | F5 | ☑ |
| G1880 | Premium Claude Design UI: knowledge add route first-viewport input board | P1 | F5 | ☑ |
| G1881 | Premium Claude Design UI: knowledge AI route first-viewport preview board | P1 | F5 | ☑ |
| G1882 | Premium Claude Design UI: treatment overview route first-viewport stage board | P1 | F5 | ☑ |
| G1883 | Premium Claude Design UI: treatment phases route first-viewport phase board | P1 | F5 | ☑ |
| G1884 | Premium Claude Design UI: treatment management route first-viewport management board | P1 | F5 | ☑ |
| G1885 | Premium Claude Design UI: treatment reimbursement route first-viewport reimbursement board | P1 | F5 | ☑ |
| G1886 | Premium Claude Design UI: treatment context route first-viewport timeline board | P1 | F5 | ☑ |
| G1887 | Premium Claude Design UI: treatment workbench first-viewport route board | P1 | F5 | ☑ |
| G1888 | Premium Claude Design UI: treatment task routes first-viewport route density polish | P1 | F5 | ☑ |
...
| G1894 | Premium Claude Design UI: treatment mobile rail forced-colors badge contrast polish | P1 | F5 | ☑ |
| G1895 | Premium Claude Design UI: treatment mobile rail forced-colors cue spacing polish | P1 | F5 | ☑ |
| G1896 | Premium Claude Design UI: treatment mobile rail forced-colors label fit polish | P1 | F5 | ☑ |
| G1897 | Premium Claude Design UI: treatment mobile rail forced-colors active cue label polish | P1 | F5 | ☑ |
| G1898 | Premium Claude Design UI: treatment mobile rail forced-colors active supporting text polish | P1 | F5 | ☑ |
| G1899 | Premium Claude Design UI: treatment mobile rail forced-colors active focus text polish | P1 | F5 | ☑ |
| G1900 | Premium Claude Design UI: treatment mobile rail forced-colors focus cue spacing polish | P1 | F5 | ☑ |
| G1901 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus text polish | P1 | F5 | ☑ |
| G1902 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus cue fit polish | P1 | F5 | ☑ |
| G1903 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus cue rhythm polish | P1 | F5 | ☑ |
| G1904 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus meta rhythm polish | P1 | F5 | ☑ |
...
| G1910 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus cue outline offset polish | P1 | F5 | ☑ |
| G1911 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus badge outline offset polish | P1 | F5 | ☑ |
| G1912 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus badge border style polish | P1 | F5 | ☑ |
| G1913 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus badge outline color polish | P1 | F5 | ☑ |
| G1914 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus badge font weight polish | P1 | F5 | ☑ |
| G1915 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus cue font weight polish | P1 | F5 | ☑ |
| G1916 | Premium Claude Design UI: treatment mobile rail forced-colors inactive focus cue outline color contrast polish | P1 | F5 | ☑ |
...
| G1958 | Fertility Intelligence: ziekenhuisdocumenttype review release evidence | P1 | F5 | ☐ |
...
| G1990 | Research Intelligence: offline cache metadata missing-term error contract | P1 | F5 | ☑ |
| G1991 | Research Intelligence: offline cache metadata missing-term release-state guard | P1 | F5 | ☑ |
| G1992 | Research Intelligence: offline cache metadata release-state missing-term fixture | P1 | F5 | ☑ |
| G1993 | Research Intelligence: offline cache metadata release-state error contract | P1 | F5 | ☑ |
| G1994 | Research Intelligence: offline cache metadata release-state contract release guard | P1 | F5 | ☑ |
| G1995 | Research Intelligence: offline cache metadata release-state contract missing-term fixture | P1 | F5 | ☑ |
| G1996 | Research Intelligence: offline cache metadata release-state contract missing-term error contract | P1 | F5 | ☑ |
| G1997 | Research Intelligence: offline cache metadata release-state contract error release guard | P1 | F5 | ☑ |
| G1998 | Research Intelligence: offline cache metadata release-state contract error missing-term fixture | P1 | F5 | ☑ |
| G1999 | Research Intelligence: offline cache metadata release-state contract error missing-term error contract | P1 | F5 | ☑ |
| G2000 | Research Intelligence: offline cache metadata release-state contract error-contract release guard | P1 | F5 | ☑ |
| G2001 | Research Intelligence: offline cache metadata release-state contract error-contract missing-term fixture | P1 | F5 | ☑ |
| G2002 | Research Intelligence: offline cache metadata release-state contract error-contract missing-term error contract | P1 | F5 | ☑ |
| G2003 | Research Intelligence: offline cache metadata release-state contract error-contract error release guard | P1 | F5 | ☑ |
| G2004 | Research Intelligence: offline cache metadata release-state contract error-contract error missing-term fixture | P1 | F5 | ☑ |
| G2005 | Research Intelligence: offline cache metadata release-state contract error-contract error missing-term error contract | P1 | F5 | ☑ |
| G2006 | Research Intelligence: offline cache metadata release-state contract error-contract error error release guard | P1 | F5 | ☑ |
| G2007 | Research Intelligence: offline cache metadata release-state contract error-contract error error missing-term fixture | P1 | F5 | ☑ |
| G2008 | Research Intelligence: offline cache metadata release-state contract error-contract error error missing-term error contract | P1 | F5 | ☑ |
| G2009 | Research Intelligence: offline cache metadata release-state contract error-contract error error error release guard | P1 | F5 | ☑ |
...
- **Totaal doelen: 2010** (id's G001 t/m G2011; G1423 is een eerder gesloten GitHub-issue en
