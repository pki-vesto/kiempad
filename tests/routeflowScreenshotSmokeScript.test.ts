...
describe('routeflow screenshot smoke script', () => {
  it('bewaakt start research en imaging als zichtbare routeflows', () => {
    ...
    expect(routeflowScreenshotSmokeScript).toContain(
      'workspace-strip-reload-hash-panel-scrollstart-body-chrome-strip-button-position-focus-text-switcher-scrollbar-overscroll-overscrollinline-overflowy-overflowinline-overflowblock-snap-active-align-padding-margin-stop-touch-textsize-font-tap-gap-align-justify-display-visible-position-inset-zindex-minwidth-maxwidth-shrink-grow-basis-box-padding-block-margin-block-border-style-color-radius-background-shadow-filter-backdrop-opacity-visibility',
    );
    ...
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherOverflowInlineStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherOverflowBlockStable');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherBoxShadowStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherFilterStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherBackdropFilterStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherOpacityStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherVisibilityStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherPositionStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherInsetStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherZIndexStable');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherMaxWidthStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherFlexShrinkStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherFlexGrowStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherFlexBasisStable');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherMarginInlineStable');
    expect(routeflowScreenshotSmokeScript).toContain('smallMobileSwitcherMarginBlockStable');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderBlockStartWidth');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderBlockEndWidth');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderInlineStartWidth');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderInlineEndWidth');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderBlockStartStyle');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderBlockEndStyle');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderInlineStartStyle');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderInlineEndStyle');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderBlockStartColor');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderBlockEndColor');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderInlineStartColor');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderInlineEndColor');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBorderStartStartRadius');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBoxShadow');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherFilter');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherBackdropFilter');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherOpacity');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherVisibility');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherPosition');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherInsetBlockStart');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherInsetBlockEnd');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherInsetInlineStart');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherInsetInlineEnd');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherZIndex');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherOverflowBlock');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherOverflowInline');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherMarginBlockStart');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherMarginBlockEnd');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherMarginInlineStart');
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherMarginInlineEnd');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('workspaceSwitcherOverscrollBehaviorInline');
    expect(routeflowScreenshotSmokeScript).toContain(
    ...
    expect(routeflowScreenshotSmokeScript).toContain('routeGroupSummaryOutlineWidth');
    expect(routeflowScreenshotSmokeScript).toContain('routeGroupSummaryBoxShadow');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('routeGroupSummaryTitleFontWeight');
    expect(routeflowScreenshotSmokeScript).toContain('routeGroupSummaryContextColor');
    expect(routeflowScreenshotSmokeScript).toContain('routeGroupSummaryContextFontWeight');
    ...
    expect(routeflowScreenshotSmokeScript).toContain('focusRows');
    expect(routeflowScreenshotSmokeScript).toContain('labelTextDecorationLine');
    expect(routeflowScreenshotSmokeScript).toContain("field.outlineWidth === '0px'");
