...
- **G1978 Research Intelligence trend dashboard metadata routeflow evidence — done in G1978 / issue #3893.** Routeflow-smoke opent de Kennis trenddisclosure en bewaakt `data-research-trend-dashboard`, topic cards, publicatie-/brontellingen, laatste update, per-item periode, bron, update-status, laatste check, relevantietekst en bounded layout op desktop, tablet, mobiel en small-mobile zonder providerpayload, secrets, trackingpayload of medisch advies.
- **G1977 Research Intelligence literature query builder routeflow evidence — done in G1977 / issue #3891.** Routeflow-smoke bewaakt `data-literature-query-builder` op de Kennis researchroute met querypreview, gede-identificeerde contextlabels, bewerkbare termen, bewaaractie, uitgesloten-contextchips en bounded layout op desktop, tablet, mobiel en small-mobile zonder dossierplaintext, bestandsnamen, secrets, trackingpayload of medisch advies.
- **G1979 Daily Recommendations personalization feedback routeflow evidence — done in G1979 / issue #3896.** Routeflow-smoke opent Dagadvies met lokale `niet_passend` feedbackstatus en bewaakt `data-daily-recommendation-personalization`, status, tijdelijke negatieve-feedbackhook, uitleg dat vergelijkbare suggesties niet definitief verborgen worden en zichtbare andere aanbevelingen zonder secrets, trackingpayload of medisch advies.
- **G1980 Daily Recommendations owner visibility routeflow evidence — done in G1980 / issue #3898.** Routeflow-smoke opent Dagadvies met een lokaal verborgen eigenaar en bewaakt `data-daily-recommendation-owner-visibility`, hidden-count, eigenaarstatus, bron, datum, reviewstatus, herstelactie en zichtbare lijstfiltering zonder secrets, trackingpayload of medisch advies.
- **G1981 Daily Recommendations source confidence routeflow evidence — done in G1981 / issue #3900.** Routeflow-smoke bewaakt nu `data-daily-recommendation-bronconfidence` in de Dagadvieskaartlijst met label, score, bron, datum, reviewstatus, broncategorieen en lekenuitleg op desktop, tablet, mobiel en small-mobile zonder horizontale overflow, secrets, trackingpayload of medisch advies.
- **G1982 Daily Recommendations feedback analytics routeflow evidence — done in G1982 / issue #3902.** Routeflow-smoke opent Dagadvies met lokale feedback-eventlogs en bewaakt `data-daily-advice-feedback-analytics`, total, statusverdeling, eigenaarverdeling, laatste feedbackdatum, bron, reviewstatus en no-tracking copy op desktop, tablet en mobiel zonder horizontale overflow, secrets, trackingpayload of medisch advies.
- **G1983 Research Intelligence trend update timestamp routeflow evidence — done in G1983 / issue #3904.** Routeflow-smoke bewaakt nu `data-research-trend-update-timestamp` in Kennis Research met datum, bron, reviewstatus, correctievelden en uitleg vóór trenditems; de evidence blokkeert secrets, plaintext payload, diagnose, dosering, kansberekening en behandelkeuzeadvies.
- **G1984 Research Intelligence patient summary reading-level routeflow evidence — done in G1984 / issue #3906.** Kennis Research toont nu een compacte leesniveau-scan vóór de eenvoudige samenvattingen met status, bron, datum, reviewstatus, vaktaalsignalering en correctievelden; routeflow-smoke bewaakt `data-research-summary-reading-level-guard` en de scan op desktop, tablet en mobiel zonder secrets, plaintext payload of medisch advies.
- **G1985 Research Intelligence source citation parser routeflow evidence — done in G1985 / issue #3908.** Kennis Research toont nu een compacte broncitatie-scan vóór de researchsamenvattingen met parserstatus, bron, datum, reviewstatus, citationtype en correctievelden; routeflow-smoke bewaakt `data-research-source-citation-parser` en de scan op desktop, tablet en mobiel zonder secrets, plaintext payload of medisch advies.
- **G1986 Research Intelligence clinician question generator routeflow evidence — done in G1986 / issue #3910.** Kennis Research toont nu een compacte artsvragen-scan vóór de researchrelevantie-details met vraagtekst, bron, datum, reviewstatus en correctievelden; routeflow-smoke bewaakt `data-research-clinician-questions` en de scan op desktop, tablet en mobiel zonder secrets, plaintext payload of medisch advies.
...
- **G1950 Fertility Intelligence metadata-normalisatie correctieformulier release evidence — done in G1950 / issue #3846.** Releasecontext in runbook, completion audit, changelog, current state en onderhoudstest koppelt `dossier-metadata-normalization-correction`, `dossierMetadataNormalizationCorrection`, metadata-normalisatievelden, save-actie en locked boundary aan `npm run smoke:routeflows`, zodat datum, bron, documenttype, onderzoekstype, poging, afspraak, onzekerheid en bewaaractie scanbaar blijven zonder medische payload, OCR-payload, bronbestandsnamen, locked bronplaintext, secrets of trackingdata.
- **G1951 Fertility Intelligence historische tijdlijnreview release evidence — done in G1951 / issue #3848.** Releasecontext in runbook, completion audit, changelog, current state en onderhoudstest koppelt `dossier-historical-timeline-review`, `dossierHistoricalTimelineReview`, tijdlijnreviewvelden, save-actie en locked boundary aan `npm run smoke:routeflows`, zodat datum, bron, reviewstatus, zichtbaarheid en bewaaractie scanbaar blijven zonder medische payload, OCR-payload, bronbestandsnamen, locked bronplaintext, secrets of trackingdata.
- **G1952 Premium Claude Design UI daily recommendation owner scan release evidence — done in G1952 / issue #3850.** Releasecontext in runbook, completion audit, changelog, current state en onderhoudstest koppelt `daily-advice-console`, `dailyAdviceOwnerScanOverflow`, `data-daily-advice-owner-scan="ready"` en de vrouw/man/samen cards aan `npm run smoke:routeflows`, zodat de owner-scan zichtbaar blijft voor decision lanes en list details zonder page-level overflow, medische payload, OCR-tekst, broninhoud, secrets, tokens of trackingpayloads.
- **G1953 Premium Claude Design UI treatment mobile rail forced-colors cue text fill release evidence — done in G1953 / issue #3852.** Releasecontext in runbook, completion audit, changelog, current state en onderhoudstest koppelt de app-shell forced-colors CSS-test voor `.treatment-task-route:not([aria-current="page"]):focus-visible .command-task-route__cue` aan `ButtonFace`, `ButtonText`, `CanvasText`, `-webkit-text-fill-color: ButtonText`, `forced-color-adjust: auto` en actieve Highlight cue-fill distinctie zonder medische payload, OCR-tekst, broninhoud, secrets, tokens of trackingpayloads.
...
- **G2012 Research Intelligence offline cache metadata release-state contract error-contract error error error error release guard — done in G2012 / issue #3962.** Maintenance-docs test bewaakt nu release-evidence voor het G2011 `offline-cache-metadata-release-state-contract-error-contract-error-error-error-missing-term-error-contract` met de foutmeldingcontext `Offline cache metadata release-state contract error-contract error error error releasecontext ontbreekt voor termen` en veilige contractlabels.
- **G2011 Research Intelligence offline cache metadata release-state contract error-contract error error error missing-term error contract — done in G2011 / issue #3960.** Maintenance-docs test snapshott nu de exacte G2010 error-contract error error error release missing-term foutmelding met alleen `offline cache metadata missing-term error contract` en `veilige technische labels` als veilige contractlabels.
- **G2010 Research Intelligence offline cache metadata release-state contract error-contract error error error missing-term fixture — done in G2010 / issue #3958.** Maintenance-docs test geeft nu compact terug wanneer de veilige labels `offline cache metadata missing-term error contract` of `veilige technische labels` uit G2009 error-contract error error error release-evidence ontbreken.
- **G2009 Research Intelligence offline cache metadata release-state contract error-contract error error error release guard — done in G2009 / issue #3956.** Maintenance-docs test bewaakt nu release-evidence voor het G2008 `offline-cache-metadata-release-state-contract-error-contract-error-error-missing-term-error-contract` met de foutmeldingcontext `Offline cache metadata release-state contract error-contract error error releasecontext ontbreekt voor termen` en veilige contractlabels.
- **G2008 Research Intelligence offline cache metadata release-state contract error-contract error error missing-term error contract — done in G2008 / issue #3954.** Maintenance-docs test snapshott nu de exacte G2007 error-contract error error release missing-term foutmelding met alleen `offline cache metadata missing-term error contract` en `veilige technische labels` als veilige contractlabels.
- **G2007 Research Intelligence offline cache metadata release-state contract error-contract error error missing-term fixture — done in G2007 / issue #3952.** Maintenance-docs test geeft nu compact terug wanneer de veilige labels `offline cache metadata missing-term error contract` of `veilige technische labels` uit G2006 error-contract error error release-evidence ontbreken.
- **G2006 Research Intelligence offline cache metadata release-state contract error-contract error error release guard — done in G2006 / issue #3950.** Maintenance-docs test bewaakt nu release-evidence voor het G2005 `offline-cache-metadata-release-state-contract-error-contract-error-missing-term-error-contract` met de foutmeldingcontext `Offline cache metadata release-state contract error-contract error releasecontext ontbreekt voor termen` en veilige contractlabels.
- **G2005 Research Intelligence offline cache metadata release-state contract error-contract error missing-term error contract — done in G2005 / issue #3948.** Maintenance-docs test snapshott nu de exacte G2004 error-contract error release missing-term foutmelding met alleen `offline cache metadata missing-term error contract` en `veilige technische labels` als veilige contractlabels.
- **G2004 Research Intelligence offline cache metadata release-state contract error-contract error missing-term fixture — done in G2004 / issue #3946.** Maintenance-docs test geeft nu compact terug wanneer de veilige labels `offline cache metadata missing-term error contract` of `veilige technische labels` uit G2003 error-contract error release-evidence ontbreken.
- **G2003 Research Intelligence offline cache metadata release-state contract error-contract error release guard — done in G2003 / issue #3944.** Maintenance-docs test bewaakt nu release-evidence voor het G2002 `offline-cache-metadata-release-state-contract-error-contract-missing-term-error-contract` met de foutmeldingcontext `Offline cache metadata release-state contract error-contract releasecontext ontbreekt voor termen` en veilige contractlabels.
- **G2002 Research Intelligence offline cache metadata release-state contract error-contract missing-term error contract — done in G2002 / issue #3942.** Maintenance-docs test snapshott nu de exacte G2001 error-contract release missing-term foutmelding met alleen `offline cache metadata missing-term error contract` en `veilige technische labels` als veilige contractlabels.
- **G2001 Research Intelligence offline cache metadata release-state contract error-contract missing-term fixture — done in G2001 / issue #3940.** Maintenance-docs test geeft nu compact terug wanneer de veilige labels `offline cache metadata missing-term error contract` of `veilige technische labels` uit G1999 error-contract release-evidence ontbreken.
- **G2000 Research Intelligence offline cache metadata release-state contract error-contract release guard — done in G2000 / issue #3938.** Maintenance-docs test bewaakt nu release-evidence voor het G1999 `offline-cache-metadata-release-state-contract-error-missing-term-error-contract` met de foutmeldingcontext `Offline cache metadata release-state contract error releasecontext ontbreekt voor termen` en veilige contractlabels.
- **G1999 Research Intelligence offline cache metadata release-state contract error missing-term error contract — done in G1999 / issue #3936.** Maintenance-docs test snapshott nu de exacte G1998 contracterror release missing-term foutmelding met alleen `offline cache metadata missing-term error contract` en `veilige technische labels` als veilige contractlabels.
- **G1998 Research Intelligence offline cache metadata release-state contract error missing-term fixture — done in G1998 / issue #3934.** Maintenance-docs test geeft nu compact terug wanneer de veilige labels `offline cache metadata missing-term error contract` of `veilige technische labels` uit G1996 contracterror release-evidence ontbreken.
- **G1997 Research Intelligence offline cache metadata release-state contract error release guard — done in G1997 / issue #3932.** Maintenance-docs test bewaakt nu release-evidence voor het G1996 `offline-cache-metadata-release-state-contract-missing-term-error-contract` met de foutmeldingcontext `Offline cache metadata release-state contract releasecontext ontbreekt voor termen` en veilige contractlabels.
...
- **G1992 Research Intelligence offline cache metadata release-state missing-term fixture — done in G1992 / issue #3922.** Maintenance-docs test geeft nu compact terug wanneer het G1990 contractlabel of `veilige technische labels` uit offline-cache release-state evidence ontbreekt, zonder gevoelige payloadtermen.
- **G1991 Research Intelligence offline cache metadata missing-term release-state guard — done in G1991 / issue #3920.** Maintenance-docs test bewaakt nu release-state evidence voor het G1990 offline-cache missing-term contract met veilige selectorlabels en privacygrens.
...
- **Knowledge add first-viewport input board — done in G1880 / issue #3702.** Kennis/Toevoegen
  ...
  and mobile.
- **Knowledge AI first-viewport preview board — done in G1881 / issue #3704.** Kennis/AI now
...
- **Treatment mobile rail active thumb reach polish — done in G1890 / issue #3722.**
...
- **Treatment mobile rail forced-colors badge contrast polish — done in G1894 / issue #3730.**
  Mobile Traject badges and cue pills now have explicit forced-colors contrast rules for active
  and inactive route cards, keeping route status readable in high-contrast contexts.
...
- **Treatment mobile rail forced-colors inactive focus label weight polish — done in G1906 / issue #3754.**
  Inactive focused mobile Traject titles now keep a calmer forced-colors weight and no underline,
  preserving keyboard focus without mimicking active route emphasis.
- **Treatment mobile rail forced-colors inactive focus badge tone polish — done in G1907 / issue #3756.**
  Inactive focused mobile Traject badges now keep Canvas/CanvasText system tones and calmer weight,
  preserving status readability without copying active route badge styling.
- **Treatment mobile rail forced-colors inactive focus cue tone polish — done in G1908 / issue #3758.**
  Inactive focused mobile Traject cue pills now keep ButtonFace/ButtonText system tones and calmer
  weight, preserving cue readability without copying active cue styling.
...
- **Treatment mobile rail forced-colors inactive focus badge border style polish — done in G1912 / issue #3766.**
  Inactive focused mobile Traject badges now use explicit one-pixel solid system borders, keeping
  status affordance predictable in forced-colors mobile mode.
...
- **Treatment mobile rail forced-colors inactive focus cue background contrast polish — done in G1918 / issue #3778.**
  Inactive focused mobile Traject cue pills now keep ButtonFace as both shorthand and longhand
  background, preserving readable cue contrast with ButtonText labels and CanvasText borders.
...
- **Embryo image classification routeflow evidence — done in G1942 / issue #3830.** Routeflow
  ...
  advice.
- **Embryo image classification forced-colors evidence — done in G1943 / issue #3832.** The
...
- Partial G1718/#3379: Focused forced-colors image-context badges now explicitly keep the
...
- Partial G1723/#3389: Focused forced-colors image-context badges now explicitly keep
...
- Partial G1747/#3437: Small-mobile reload smoke now verifies the active
  workspace-strip button remains positioned inside the visible strip after reload.
- Partial G1748/#3439: Small-mobile reload smoke now verifies the active
...
- Partial G1756/#3455: Small-mobile active workspace-strip buttons now keep inline
...
- Partial G1765/#3473: Small-mobile workspace-strip switchers now keep stable
  flex display, guarded by reload smoke.
- Partial G1766/#3475: Small-mobile workspace-strip switchers now keep zero
...
- Partial G1769/#3481: Small-mobile workspace-strip switchers now keep stable
  flex-grow, guarded by CSS and reload smoke.
- Partial G1770/#3483: Small-mobile workspace-strip switchers now keep stable
...
- Partial G1773/#3489: Small-mobile workspace-strip switchers now keep stable
...
- Partial G1776/#3495: Small-mobile workspace-strip switchers now keep stable
  border-width, guarded by CSS and reload smoke.
- Partial G1777/#3497: Small-mobile workspace-strip switchers now keep stable
...
- Partial G1780/#3503: Small-mobile workspace-strip switchers now keep stable
...
- Partial G1783/#3509: Small-mobile workspace-strip switchers now keep stable
...
- Partial G1786/#3515: Small-mobile workspace-strip switchers now keep visible
  display settings, guarded by CSS and reload smoke.
- Partial G1787/#3517: Small-mobile workspace-strip switchers now keep stable
  position settings, guarded by CSS and reload smoke.
- Partial G1788/#3519: Small-mobile workspace-strip switchers now keep stable
...
- Partial G1793/#3529: Small-mobile workspace-strip switchers now keep stable
  overscroll-behavior-inline settings, guarded by CSS and reload smoke.
...
- Partial G1831/#3605: Dossier upload active route micro-labels now keep a
  normal font style in their own small-mobile forced-colors rule, preventing
  accidental italic emphasis from competing with the title or context.
...
- Partial G1854/#3650: Attachment-envelope batch progress states now have
